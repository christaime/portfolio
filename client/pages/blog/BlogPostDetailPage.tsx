...
import { ArrowLeft, Clock, Calendar, User, Shield, Loader2 } from 'lucide-react';
      ...
      <div className="mt-14 p-6 md:p-8 bg-[#0a1f33] border border-[#1b3450] rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
        <div>
          ...
          <p className="text-xs text-[#9cb2cd]">
            {t('contact.immediateAvailabilityDesc', 'Open for technical architecture reviews and engineering engagements.')}
          </p>
        </div>
        <Link
          to="/contact"
