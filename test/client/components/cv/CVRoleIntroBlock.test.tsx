...
import { CVRoleIntroBlock } from '@/client/components/cv/CVRoleIntroBlock';
...
describe('CVRoleIntroBlock Component', () => {
  ...
  it('renders targeted offer when service is selected and allows resetting view', () => {
    ...
    expect(screen.getByText(/Targeted Offer/i)).toBeInTheDocument();
    expect(screen.getByRole('heading', { name: '.NET & C# Enterprise Solutions' })).toBeInTheDocument();
